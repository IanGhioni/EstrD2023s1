...
int main() {
    ...
    insertBBNodeDFS(t, 0, 1);
    insertBBNodeBFS(t, 0, 2);
    insertBBNodeDFS(t, 0, 3);
    insertBBNodeBFS(t, 0, 4);
    insertBBNodeDFS(t, 0, 5);
    insertBBNodeBFS(t, 1, 2);
    insertBBNodeDFS(t, 1, 3);
    insertBBNodeBFS(t, 1, 5);
    insertBBNodeDFS(t, 2, 3);
    insertBBNodeBFS(t, 2, 4);
    insertBBNodeDFS(t, 2, 1); 
    insertBBNodeBFS(t, 1, 1); 
    insertBBNodeDFS(t, 2, (-2));  
    insertBBNodeBFS(t, (-4), (-3));
    insertBBNodeDFS(t, (-40), (-10));
    insertBBNodeBFS(t, (-50), (-20));
    insertBBNodeDFS(t,-60,-30);
    insertBBNodeBFS(t,-65,-35);
    insertBBNodeDFS(t,-90,-100);
    /*
